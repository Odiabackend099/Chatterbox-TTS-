...
##############################################################################
# RUNPOD DEPLOYMENT - PORT 8000
##############################################################################
# Deploy TTS service on port 8000 (avoiding Jupyter's 8888)
# Pod ID: aav4qfa6yqgt3k
# Run this ON YOUR RUNPOD POD after SSH'ing in or via Web Terminal
##############################################################################
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  Chatterbox TTS - RunPod Deployment (Port 8000)${NC}"
echo -e "${BLUE}  Pod ID: aav4qfa6yqgt3k${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}\n"
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  Step 4: Configuring Environment (Port 8000)${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}\n"

cat > .env << 'EOF'
# TTS Configuration - Port 8000 (avoiding Jupyter's 8888)
...
echo -e "${GREEN}✓ Environment configured for port 8000${NC}\n"
...
# Check if model cache was transferred
if [ -d "/workspace/model_cache" ] && [ "$(ls -A /workspace/model_cache 2>/dev/null)" ]; then
    echo -e "${GREEN}✓ Model cache found (transferred from old pod)${NC}"
    du -sh /workspace/model_cache
else
    echo -e "${YELLOW}⚠ No model cache found - will download on first run${NC}"
fi
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  Step 7: Starting TTS Service on Port 8000${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}\n"
...
echo -e "  Public: ${GREEN}https://aav4qfa6yqgt3k-8000.proxy.runpod.net${NC}\n"
...
echo -e "  ${YELLOW}curl https://aav4qfa6yqgt3k-8000.proxy.runpod.net/api/health${NC}\n"
